(function () {
    ...
    var View = Backbone.View.extend({
        ...
        initialize: function (options) {
            var text = {
                channel_name: utils.translateText('client_applets_chanlist_channelname'),
                users: utils.translateText('client_applets_chanlist_users'),
                topic: utils.translateText('client_applets_chanlist_topic')
            };
    ...
    var Applet = Backbone.Model.extend({
        initialize: function () {
            this.set('title', utils.translateText('client_applets_chanlist_channellist'));
            this.view = new View();
