...
conf.quit_message = "https://learnable.com – Learn design and web development from the masters";
...
conf.restrict_server = "irc.freenode.net";
conf.restrict_server_port = 6667;
//conf.restrict_server_ssl = false;
conf.restrict_server_channel = "#sitepoint";
